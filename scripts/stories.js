let story1 = {
  steps: [
    ...
    ["task"],
    ["text_msg", "task"],
    ["character", "text_msg", "task_title", "task"],
    ["task"],
    ["task"],
    ["task"],
    ["task"],
    ["text_msg", "task_title", "task"]
  ],
  ...
  "Mobile numbers can be used to send money to as well",
